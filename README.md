...
The `params` object is used to carry the PKCE parameters. The `code_challenge` should be generated by your server and passed to the JS, ensuring that only your server ever has the `code_verifier` value.
